                ...
                <div className={styles.content}>
                    <div>
                        ...
                        <p className={styles.desc}>
                            We want to connect the people who have knowledge to
                            the people who need it, to bring together people
                            with different perspectives so they can understand
                            each other better, and to empower everyone to share
                            their knowledge.
                        </p>
                    </div>
                    <button className={styles.btn}>Create A New Account</button>
                </div>
            </div>
        </div>
    );
