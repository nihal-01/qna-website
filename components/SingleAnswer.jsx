...
const styles = {
    container: `px-[15px] py-[15px] lg:p-[30px] border-b border-borderColor flex gap-[20px]`,
    ...
    createdAt: `text-grayColor text-[15px] mt-[8px]`,
    desc: `text-primaryColor text-base leading-[28px] lg:text-[18px] lg:leading-loose mt-[1em] mb-[1em]`,
    answerFooter: `flex items-center justify-between`,
    answerFooterLeft: `flex items-center`,
    voteWrapper: `flex items-center gap-[10px] mr-[15px] pr-[15px] border-r border-borderColor`,
    voteIcon: `block text-[#677075] cursor-pointer transition-all hover:text-primaryColor`,
    voteTxt: `text-lg font-bold text-[#677075]`,
    replyBtnWrapper: `relative mr-[15px] pr-[15px] border-r border-borderColor`,
    replyBtn: `flex items-center text-[#464e7b] gap-[10px] text-[15px] transition-all hover:text-secondaryColor`,
    shareBtnWrapper: `group relative py-[10px] `,
    shareBtn: `flex items-center text-[#464e7b] gap-[10px] text-[15px]`,
    shareIconList: `absolute top-[40px] left-0 bg-white shadow-[0_1px_5px_#d0d2d3] rounded-sm overflow-hidden translate-x-[15px] transition-all opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:translate-x-0`,
