...
const styles = {
    container: `bg-[#f9f9f9] mb-[20px] border border-[#e1e3e3] p-[15px] lg:p-[22px] `,
    ...
    answerTxt: `text-grayColor pt-[15px] mt-[15px] border-t border-[#e1e3e3] text-[15px] leading-relaxed lg:text-[16px] lg:mt-[22px] lg:pt-[18px] `,
};
